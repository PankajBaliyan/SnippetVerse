...
export const LanguageDropdown = ({ languages, selectedLanguage, onLanguageChange }: LanguageDropdownProps) => {
        ...
        <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-60 overflow-y-auto">
          <button
            ...
            className={`w-full px-4 py-2 text-left hover:bg-gray-50 dark:hover:bg-gray-700 ${
              selectedLanguage === 'all' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'
            }`}
          >
            All Languages
          </button>
          {languages.map((language) => (
            <button
              ...
              className={`w-full px-4 py-2 text-left capitalize hover:bg-gray-50 dark:hover:bg-gray-700 ${
                selectedLanguage === language ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'
              }`}
            >
              {language}
            </button>
